...
public class FlightBooking {
    ...
    public void setTicketNumber(String fullName) {
        this.ticketNumber = "FOFT" + fullName.substring(1,4).toUpperCase() + TRIP_SOURCE.substring(1,4).toUpperCase() 
        + TRIP_DESTINATION.substring(1,4).toUpperCase() 
        + "IN";
    }
    ...
    public void setDepartingTicketPrice(int child, int adults){
        departingTicketPrice = (child * 500) + (adults * 750);
    }
    ...
    public void setReturnTicketPrice(int child, int adults){
        returnTicketPrice = (child * 450) + (adults * 1050);
    }
